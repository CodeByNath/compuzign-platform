...
- [RequestsModule.php](../../wp-content/plugins/compuzign-platform/src/Modules/Requests/RequestsModule.php) registers the `[compuzign_quote_view]` shortcode (Phase 8J-C2), sharing the existing `compuzign-cost-builder` JS/CSS handles rather than a new build entry.
