...
- [PackageTierWorkspace.tsx](../../wp-content/plugins/compuzign-platform/resources/ts/package-station/presentation/package-tier-workspace/PackageTierWorkspace.tsx) owns transient slot and Focus/Grid selection. A Family without an assignment receives a setup surface rather than five implied Tier records. Once an instance exists, its Focus shell always presents the five real fixed slots. The Admin Package Family host adapters navigate to the registered Packages destination; the Package-owned instance hand-off then selects scope and produces visible focus/scroll/live-region feedback even when identity was already selected.
- [TierLowerDeck.tsx](../../wp-content/plugins/compuzign-platform/resources/ts/package-station/presentation/package-tier-workspace/TierLowerDeck.tsx) presents Details/Connections/Settings beneath the engine. [TierSystemSettings.tsx](../../wp-content/plugins/compuzign-platform/resources/ts/package-station/presentation/package-tier-workspace/TierSystemSettings.tsx) guides explicit create-then-assign setup, opens fixed slots in the authoritative Tier drawer, distinguishes system Rate Sheet access from per-Tier binding, and owns removal confirmation plus Package Manager links. [TierRateSheetInventory.tsx](../../wp-content/plugins/compuzign-platform/resources/ts/package-station/presentation/package-tier-workspace/TierRateSheetInventory.tsx) shows access/current users.
- [TierDrawerHost.tsx](../../wp-content/plugins/compuzign-platform/resources/ts/package-station/surface/tierSurface/TierDrawerHost.tsx) decodes either `(tier_instance_id, occupant_id)` for a real occupant or `(tier_instance_id, slotId)` for an empty fixed slot, then mounts the existing drawer composition. Empty slots receive setup guidance and never receive a fabricated `occ_…` identity.
