...
- [tierRateSheetAccessModel.ts](../../wp-content/plugins/compuzign-platform/resources/ts/package-station/surface/tierInstance/tierRateSheetAccessModel.ts) matches Rate Sheets and projects only their direct `bundles[]` children. Parent access remains `allowed_rate_sheet_ids`; exact Bundle access uses `(rate_sheet_id, bundle_id)`. It never inspects `groups[]`, `items[]`, or compiled Bundle rows.
- [TierInstanceSchema.php](../../wp-content/plugins/compuzign-platform/src/Modules/SurfacePackages/Support/TierInstanceSchema.php) sanitizes direct Bundle access; [PackageStationController.php](../../wp-content/plugins/compuzign-platform/src/Modules/SurfacePackages/Http/PackageStationController.php) persists both access levels atomically.
