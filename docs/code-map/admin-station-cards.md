...
Card visual direction: restrained and near-monochrome. The accent is spent in a few small places — the **filled** medallion plate, the optional code pill, and the primary action — never as outlines on every element.
