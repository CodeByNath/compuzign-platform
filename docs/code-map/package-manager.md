...
### Tools / Skills — three owners

- **Registration + catalogue → Package Station.** Registry: [PackageToolRegistry.php](../../wp-content/plugins/compuzign-platform/src/Modules/SurfacePackages/Support/PackageToolRegistry.php), [packageTools.ts](../../wp-content/plugins/compuzign-platform/resources/ts/modules/packages/packageTools.ts). The catalogue renders **once at Station level** — the Package Station Home `Tools / Skills` wall (source `package-tools` [usePackageToolCatalogue.ts](../../wp-content/plugins/compuzign-platform/resources/ts/admin-station/stations/packageTools/usePackageToolCatalogue.ts), kit [PackageToolCatalogue.tsx](../../wp-content/plugins/compuzign-platform/resources/ts/admin-station/presentation/package-tools/PackageToolCatalogue.tsx)). Presentation only: availability, assigned-Family counts, authority; **mutates nothing**. Future tools appear here only, as roadmap rows.
- **Assignment state → the Family / Group.** A `tools` map on the `category_groups` row (`tools[key] = {enabled}`), mutated by [PackageCategoryGroups.php](../../wp-content/plugins/compuzign-platform/src/Modules/SurfacePackages/Support/PackageCategoryGroups.php) (`setTool`), gated by the registry. **No** global `package-station` owner. Route `PUT /admin/package-category-groups/{gid}/tools/{tool}` ([AdminPackageCategoryGroupsController.php](../../wp-content/plugins/compuzign-platform/src/Modules/Admin/Http/AdminPackageCategoryGroupsController.php)). The Family Settings tab is a **compact** panel ([PackageFamilyToolsPanel.tsx](../../wp-content/plugins/compuzign-platform/resources/ts/entity-drawers/package-family/PackageFamilyToolsPanel.tsx)) — immediate-save Activate/Deactivate; it never repeats the catalogue.
- **Tool data + lifecycle → the tool's authority.** **Tier** is the first real tool; data stays station-global. Activating flips a boolean, mints no occupant. See [package-family-tools-blueprint.md](../architecture/package-family-tools-blueprint.md) §13.
