...
- **Move:** `resources/ts/entity-drawers/package-family/` (4 files) → `package-station/drawer/package-family/`; `entity-drawers/tier/` (9) → `drawer/tier/`; `entity-drawers/editors/{PackageFamilyOverviewEditor,TierOverviewEditor,PoolFaqsEditor,PoolInclusionsEditor}.tsx` (Pool editors verified Tier-only) → `drawer/editors/`; `entity-drawers/schema/bindings/{packageFamily,tier}.tsx` → `drawer/schema/bindings/`; `entity-drawers/schema/entities/{packageFamily,tier}.ts` → `drawer/schema/entities/`.
