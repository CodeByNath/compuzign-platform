...
const CTX = {
  ...
  parentBlockedPromo: { platformStatus: 'active', parentReady: false, parentLabel: 'Promotion Overview' },
...
const cases = [
  ...
  ['promoFeatures.blocked',       dna.promotionFeaturesModule, { count: 1 },                                     CTX.parentBlockedPromo],
