...
class AssetLoader
{
    ...
    private function registerCostBuilderAssets(): void
    {
        ...
        if (file_exists($distPath . 'js/cost-builder.js')) {
            wp_register_script('compuzign-cost-builder', $distUrl . 'js/cost-builder.js', [], COMPUZIGN_PLUGIN_VERSION, true);
        } elseif (file_exists($fallbackPath . 'js/cost-builder.js')) {
            wp_register_script('compuzign-cost-builder', $fallbackUrl . 'js/cost-builder.js', [], COMPUZIGN_PLUGIN_VERSION, true);
        }
    }
}
