...
- `../temporary-service-catalogue-seed/TemporaryServiceCatalogueSeedAction.tsx` — temporary authenticated footer action; it orchestrates the existing Category and Service APIs and owns no persistence. Remove after the supplied ten-Service live run and rerun are verified.
