...
export function AdminStationBody() {
  ...
  // The intent seam. Every dispatch carries the acted-on record's numeric id, the
  // binding's resolved intent (target + tab), and the surface's drawer template —
  // the controller opens the shared drawer over that numeric record.
  const handleIntent = openFromIntent;
