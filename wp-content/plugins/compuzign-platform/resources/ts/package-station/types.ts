...
export interface SurfaceTierDetail {
  ...
  addon_platform_id: string;
  /** Output-only permanent Composable Catalogue identity (CZTC); empty until this composable occupant first settles — reserved automatically, no admin declaration needed. Coexists with, never replaces, platform_id above. */
  catalogue_platform_id: string;
...
export interface TierEdition {
  ...
  /** Output-only permanent Composable Edition Catalogue identity (CZTEC); empty until this composable Edition first activates — reserved automatically, no admin declaration needed. Coexists with, never replaces, edition_platform_id above. */
  edition_catalogue_platform_id: string;
