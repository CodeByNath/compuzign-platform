...
//
// Rate Sheet binding, Commitment, and the reusable cadence pool moved to
// Tier Pricing Rules (TierPricingRulesEditor.tsx); Billing Cycle is retired
// from every editing surface entirely. See
// docs/code-map/tier-pricing-rules-plan.md. This editor keeps only Display
// Label, Price (read-only), Customer Groups, Ideal For, Mark as Contact Us,
// Make this Tier an add-on, and Mark as popular tier.
//
