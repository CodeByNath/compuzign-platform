...
import type { CategoryOverviewDraft, CategoryStationItem, SurfacePackageSummary } from '@/api/types/admin';
...
export function CategoryCatalogStation({ refreshKey, openAction }: Props) {
  ...
  const dataRef = useRef<{ stations: ServiceSummary[]; packages: SurfacePackageSummary[]; categories: Category[] }>({
