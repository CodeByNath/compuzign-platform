...
// a getter reading the station's live ref — so reopening a drawer (e.g.
// returning from a service edit) reads fresh counts. onRefresh refetches the
// station streams; openAction is the ActionShell opener.
export interface CategoryDrawerDeps {
  getCatalogData: () => { stations: ServiceSummary[]; packages: SurfacePackageSummary[]; categories: Category[] };
  onRefresh?:  () => void;
...
// Category-scoped assigned services, read fresh from the station ref.
