...
export interface EntityDrawerProps {
  ...
  trailing?: Partial<Record<DrawerTabId, ComponentChildren>>;
...
export function EntityDrawer({
  entity, bindings, tab, onSelectTab, openPanel, onTogglePanel, trailing, children,
}: EntityDrawerProps) {
  const [internalTab, setInternalTab] = useState<DrawerTabId>('details');
  const activeTab = tab ?? internalTab;
  const selectTab = onSelectTab ?? setInternalTab;
