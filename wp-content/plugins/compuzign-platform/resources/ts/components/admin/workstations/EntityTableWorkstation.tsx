...
// Generic entity-table surface (S5). The workstation registry declares
...
//
// WorkstationRouter keys this component per entity:scope, so a mounted
...
export function EntityTableWorkstation({ entity, scope, refreshKey }: Props) {
