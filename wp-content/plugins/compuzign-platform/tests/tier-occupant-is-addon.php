...
check_is_addon($flippedBound['current_occupant']['rate_sheet_items'] === [['item_id' => 'rate-vm', 'quantity' => 2, 'price_option_id' => null, 'leg_index' => null, 'leg_assignments' => []]], 'marking an occupant an add-on does not touch its Rate Sheet selections');
...
check_is_addon($settled['current_occupant']['rate_sheet_items'] === [['item_id' => 'rate-vm', 'quantity' => 3, 'price_option_id' => null, 'leg_index' => null, 'leg_assignments' => []]], 'settle preserves existing Rate Sheet selections when only is_addon changes');
