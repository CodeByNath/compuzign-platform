...
migration_check($GLOBALS['mig_autoload']['cz_package_entity_identifier_migration_v5'] === 'no', 'final row rollout progress option is non-autoloaded');
migration_check(!isset($GLOBALS['mig_options']['cz_package_entity_identifier_migration_lock_v5']), 'short-lived final-rollout lock is released');
...
$progress = $GLOBALS['mig_options']['cz_package_entity_identifier_migration_v5'] ?? [];
$progress['tier_group'] = ['cursor' => 'zzzzzzzz', 'complete' => true, 'processed' => 1, 'assigned' => 0, 'preserved' => 0, 'conflicts' => []];
$GLOBALS['mig_options']['cz_package_entity_identifier_migration_v5'] = $progress;
