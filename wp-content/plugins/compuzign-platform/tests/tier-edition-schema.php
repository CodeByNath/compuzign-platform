...
check_edition($full['rate_sheet_items'] === [['item_id' => 'rate-vm', 'quantity' => 2, 'price_option_id' => null, 'leg_index' => null, 'leg_assignments' => []]], 'rate_sheet_items is sanitised through the existing sanitizeTierRateSheetSelections contract');
