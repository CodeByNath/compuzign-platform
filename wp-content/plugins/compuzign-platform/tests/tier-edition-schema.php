...
check_edition($full['rate_sheet_items'] === [['item_id' => 'rate-vm', 'quantity' => 2]], 'rate_sheet_items is sanitised through the existing sanitizeTierRateSheetSelections contract');
