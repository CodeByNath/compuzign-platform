...
check_addon_e2e($normalProjected['rate_sheet_items'] === [['item_id' => 'rate-vm', 'quantity' => 3]], 'the normal Tier keeps its Rate Sheet selections (Scenario 14: pricing remains intact)');
