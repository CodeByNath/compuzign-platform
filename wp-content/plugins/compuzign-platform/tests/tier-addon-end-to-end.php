...
check_addon_e2e($normalProjected['rate_sheet_items'] === [['item_id' => 'rate-vm', 'quantity' => 3, 'price_option_id' => null, 'leg_index' => null, 'leg_assignments' => []]], 'the normal Tier keeps its Rate Sheet selections (Scenario 14: pricing remains intact)');
